...
if img is not None and is_preprocess:
    ...
    col4.image(transition_imgs[2], caption='Step 3: Clustering Anchor Points for Component Detection', use_column_width=True)
    col5.image(transition_imgs[3], caption='Step 4: Removing Components', use_column_width=True)
    col6.image(result_img, caption='Step 5: Mapping Wires using Contours', use_column_width=True)
    col4.image(annoted_img, caption='Step 6: Classified Components', use_column_width=True)
    st.markdown("""---""")